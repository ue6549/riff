...
class SlotManager {
   ...
   */
  recyclePools = new Map(); // poolKey → slotKey[] (LIFO)
   ...
   * after the toggle.
   */
  setCrossSectionRecycling(value) {
