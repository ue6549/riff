...
const nativeModule = NativeCollectionViewModule as unknown as {
  layoutCache: NativeLayoutCacheHandle;
};

interface NativeLayoutCacheHandle {
...
export class LayoutCache {
  private readonly _native: NativeLayoutCacheHandle;
